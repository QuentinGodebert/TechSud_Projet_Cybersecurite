...
La quatrième journée a été consacrée à la finalisation du projet.
Nous avons terminé le rapport d’audit, organisé les captures d’écran, mis au propre les résultats du script Python et préparé la présentation orale.
Le dépôt GitHub a également été vérifié afin de centraliser les fichiers importants : script, exports JSON et CSV, captures, journal de projet et documents finaux.
Enfin, nous avons structuré le diaporama en reprenant le contexte de mission, les vulnérabilités identifiées, les mesures mises en place et les résultats obtenus, afin de préparer une soutenance claire et cohérent
